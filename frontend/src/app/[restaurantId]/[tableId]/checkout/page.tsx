...
export default function CheckoutPage({ params }: { params: { restaurantId: string; tableId: string } }) {
  ...
  if (step === "success") {
    return (
      <div className="max-w-md mx-auto py-8 text-center">
        ...
        <Button onClick={() => router.push(`/${params.restaurantId}/${params.tableId}`)}>Back to Menu</Button>
      </div>
    );
  }
